...
/**
  ...
  /**
     ...
     */
    public static function isLocationOnEdge($point, $polygon, $tolerance = 6000, $geodesic = true) {
 ...
 /**
     ...
     */
    public static function isLocationOnPath($point, $polyline, $tolerance = 6000, $geodesic = true) {
