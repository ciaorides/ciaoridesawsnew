...
//        print_r($users);
    ...
    public function all_amount_calculations() {
        $amount_calculations = $this->usermodel->all_amount_calculations($_POST);
        $result_count = $this->usermodel->all_amount_calculations($_POST, 1);
        $json_data = array(
    ...
    public function amount_calculations_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_amount_calculations($_GET);
        //print_r($rides);exit;
    ...
    public function all_chats() {
        $chats = $this->usermodel->all_chats($_POST);
        $result_count = $this->usermodel->all_chats($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function get_user_chats() {
        ...
        $this->data['details'] = $this->usermodel->get_user_chats($user_id);
    ...
    public function all_rider_current_location() {
        $rider_current_location = $this->usermodel->all_rider_current_location($_POST);
        $result_count = $this->usermodel->all_rider_current_location($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function get_user_rider_current_location() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_rider_current_location($user_id);
        //var_dump($this->data['row']);
    ...
    public function all_emergency_contacts() {
        $emergency_contacts = $this->usermodel->all_emergency_contacts($_POST);
        $result_count = $this->usermodel->all_emergency_contacts($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function emergency_contacts_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_emergency_contacts($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function get_user_emergency_contacts() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_emergency_contacts($user_id);
        //var_dump($this->data['row']);
    ...
    public function all_favourite_locations() {
        $favourite_locations = $this->usermodel->all_favourite_locations($_POST);
        $result_count = $this->usermodel->all_favourite_locations($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function favourite_locations_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_favourite_locations($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function get_user_favourite_locations() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_favourite_locations($user_id);
        //var_dump($this->data['row']);
    ...
    public function all_notifications() {
        $notifications = $this->usermodel->all_notifications($_POST);
        $result_count = $this->usermodel->all_notifications($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function update_notifications() {
        ...
        $this->data['created_on'] = date('Y-m-d H:i:s');
        $this->usermodel->insert_notifications($this->data);
        $this->session->set_flashdata('success', 'Record added Successfully.');
    ...
    public function all_rides() {
        $rides = $this->usermodel->all_rides($_POST);
        $result_count = $this->usermodel->all_rides($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function rides_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_rides($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function get_user_rides() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_rides($user_id);
        //var_dump($this->data['row']);
    ...
    public function ride_details() {
        $this->data['title'] = "CIAO Rides";
        if ($query = $this->usermodel->ride_details()) {
            $this->data['row'] = $query;
        }
//        echo '<pre>';
...
//        echo '</pre>';
    ...
    public function all_ongoing() {
        $ongoing = $this->usermodel->all_ongoing($_POST);
        $result_count = $this->usermodel->all_ongoing($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function ongoing_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_ongoing($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function get_user_ongoing() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_ongoing($user_id);
        //var_dump($this->data['row']);
    ...
    public function ongoing_details() {
        $this->data['title'] = "CIAO Rides";
        if ($query = $this->usermodel->ongoing_details()) {
            $this->data['row'] = $query;
        }
    ...
    public function all_completed() {
        $completed = $this->usermodel->all_completed($_POST);
        $result_count = $this->usermodel->all_completed($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function completed_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_completed($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function get_user_completed() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_completed($user_id);
        //var_dump($this->data['row']);
    ...
    public function completed_details() {
        $this->data['title'] = "CIAO Rides";
        if ($query = $this->usermodel->completed_details()) {
            $this->data['row'] = $query;
        }
        //print_r($this->data['row']);	exit;
    ...
    public function all_shceduled() {
        $shceduled = $this->usermodel->all_shceduled($_POST);
        $result_count = $this->usermodel->all_shceduled($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function scheduled_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_shceduled($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function get_user_shceduled() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_shceduled($user_id);
        //var_dump($this->data['row']);
    ...
    public function shceduled_details() {
        $this->data['title'] = "CIAO Rides";
        if ($query = $this->usermodel->shceduled_details()) {
            $this->data['row'] = $query;
        }
        //print_r($this->data['row']);    exit;
    ...
    public function all_ride_lat_lngs() {
        $ride_lat_lngs = $this->usermodel->all_ride_lat_lngs($_POST);
        $result_count = $this->usermodel->all_ride_lat_lngs($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function get_user_ride_lat_lngs() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_ride_lat_lngs($user_id);
        //var_dump($this->data['row']);
    ...
    public function all_user_bank_details() {
        $user_bank_details = $this->usermodel->all_user_bank_details($_POST);
        $result_count = $this->usermodel->all_user_bank_details($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function user_bank_details_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_user_bank_details($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function get_user_user_bank_details() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_user_bank_details($user_id);
        //var_dump($this->data['row']);
    ...
    public function all_user_feedback() {
        $user_feedback = $this->usermodel->all_user_feedback($_POST);
        $result_count = $this->usermodel->all_user_feedback($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function user_feedback_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_user_feedback($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function get_user_user_feedback() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_user_feedback($user_id);
        //var_dump($this->data['row']);
    ...
    public function all_user_ratings() {
        $user_ratings = $this->usermodel->all_user_ratings($_POST);
        $result_count = $this->usermodel->all_user_ratings($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function user_ratings_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_user_ratings($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function get_user_user_ratings() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_user_ratings($user_id);
        //var_dump($this->data['row']);
    ...
    public function all_user_vehicles() {
        $user_vehicles = $this->usermodel->all_user_vehicles($_POST);
        $result_count = $this->usermodel->all_user_vehicles($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function user_vehicles_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_user_vehicles($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function get_user_user_vehicles() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_user_vehicles($user_id);
        //var_dump($this->data['row']);
    ...
    public function all_vehicle_makes() {
        $vehicle_makes = $this->usermodel->all_vehicle_makes($_POST);
        $result_count = $this->usermodel->all_vehicle_makes($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function vehicle_makes_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_vehicle_makes($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function update_vehicle_makes() {
        ...
        if ($this->input->post('category_id') == "") {
            $this->data['created_on'] = date('Y-m-d H:i:s');
            $this->usermodel->insert_vehicle_makes($this->data);
            $this->session->set_flashdata('success', 'Record added Successfully.');
            redirect('admin/register/add_vehicle_makes', 'refresh');
        } else {
            // var_dump($this->data);exit;
            $this->data['modified_on'] = date('Y-m-d H:i:s');
            $this->usermodel->update_vehicle_makes($this->data, $this->input->post('category_id'));
            $this->session->set_flashdata('success', 'Record Updated Successfully.');
    ...
    public function edit_vehicle_makes($vehicle_makes_id) {
        $this->data['title'] = "CIAO Rides";
        if ($query = $this->usermodel->edit_vehicle_makes()) {
            $this->data['row'] = $query;
        }
        //var_dump($this->data['row']);
        $this->load->view('admin/includes/header', $this->data);
    ...
    public function get_user_vehicle_makes() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_vehicle_makes($user_id);
        //var_dump($this->data['row']);
    ...
    public function all_vehicle_models() {
        $vehicle_models = $this->usermodel->all_vehicle_models($_POST);
        $result_count = $this->usermodel->all_vehicle_models($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function vehicle_models_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_vehicle_models($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function add_vehicle_models() {
        $this->data['title'] = "CIAO Rides";
        $this->data['categories'] = $this->usermodel->vehicle_makes();
        $this->load->view('admin/includes/header', $this->data);
    ...
    public function update_vehicle_models() {
        ...
        if ($this->input->post('sub_category_id') == "") {
            ...
            $this->usermodel->insert_vehicle_models($this->data);
            $this->session->set_flashdata('success', 'Record added Successfully.');
            ...
            $this->data['modified_on'] = date('Y-m-d H:i:s');
            $this->usermodel->update_vehicle_models($this->data, $this->input->post('sub_category_id'));
            $this->session->set_flashdata('success', 'Record Updated Successfully.');
    ...
    public function edit_vehicle_models($vehicle_models_id) {
        $this->data['title'] = "CIAO Rides";
        if ($query = $this->usermodel->edit_vehicle_models()) {
            $this->data['row'] = $query;
        }
        $this->data['categories'] = $this->usermodel->vehicle_makes();
        $this->data['sub_categories'] = $this->usermodel->vehicle_models();
    ...
    public function get_user_vehicle_models() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_vehicle_models($user_id);
        //var_dump($this->data['row']);
    ...
    public function all_otherorders() {
        $otherorders = $this->usermodel->all_otherorders($_POST);
        $result_count = $this->usermodel->all_otherorders($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function otherorders_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_otherorders($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function get_user_otherorders() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_otherorders($user_id);
        //var_dump($this->data['row']);
    ...
    public function order_details() {
        $this->data['title'] = "CIAO Rides";
        if ($query = $this->usermodel->order_details()) {
            $this->data['row'] = $query;
        }
        //print_r($this->data['row']);	exit;
    ...
    public function all_instantorders() {
        $instantorders = $this->usermodel->all_instantorders($_POST);
        $result_count = $this->usermodel->all_instantorders($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function instantorders_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_instantorders($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function get_user_instantorders() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_user_instantorders($user_id);
        //var_dump($this->data['row']);
...
//all_instantorders
    ...
    public function get_all_bookings() {
        $instantorders = $this->usermodel->all_bookings($_POST);
        $result_count = $this->usermodel->all_bookings($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function all_user_payments() {
        $otherorders = $this->usermodel->all_payment_details($_POST);
        $result_count = $this->usermodel->all_payment_details($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function user_payments_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_payment_details($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function all_user_refunds() {
        $user_refunds = $this->usermodel->all_user_refunds($_POST);
        $result_count = $this->usermodel->all_user_refunds($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function all_rider_pending_payments() {
        $rider_pending_payments = $this->usermodel->all_rider_pending_payments($_POST);
        $result_count = $this->usermodel->all_rider_pending_payments($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function all_rider_paid_payments() {
        $rider_paid_payments = $this->usermodel->all_rider_paid_payments($_POST);
        $result_count = $this->usermodel->all_rider_paid_payments($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function payment_details() {
        $this->data['title'] = "CIAO Rides";
        if ($query = $this->usermodel->payment_details()) {
            $this->data['row'] = $query;
        }
        //print_r($this->data['row']);	exit;
    ...
    public function all_cancelled_rider() {
        $cancelled_rider = $this->usermodel->all_cancelled_rider($_POST);
        $result_count = $this->usermodel->all_cancelled_rider($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function cancelled_rider_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_cancelled_rider($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function get_cancelled_rider_user() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_cancelled_rider_user($user_id);
        //var_dump($this->data['row']);
    ...
    public function cancelled_rider_details() {
        $this->data['title'] = "CIAO Rides";
        if ($query = $this->usermodel->cancelled_rider_details()) {
            $this->data['row'] = $query;
        }
        //print_r($this->data['row']);    exit;
    ...
    public function all_cancelled_user() {
        $cancelled_user = $this->usermodel->all_cancelled_user($_POST);
        $result_count = $this->usermodel->all_cancelled_user($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function cancelled_user_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_cancelled_user($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function get_cancelled_user_user() {
        $this->data['title'] = "CIAO Rides";
        $user_id = $this->input->post('user_id');
        $this->data['details'] = $this->usermodel->get_cancelled_user_user($user_id);
        //var_dump($this->data['row']);
    ...
    public function cancelled_user_details() {
        $this->data['title'] = "CIAO Rides";
        if ($query = $this->usermodel->cancelled_user_details()) {
            $this->data['row'] = $query;
        }
        //print_r($this->data['row']);	exit;
    ...
    function all_users() {
        ...
        $config['total_rows'] = $this->usermodel->photo_gal_count();
        $config['per_page'] = 20;
        ...
        $this->data['photo'] = $this->usermodel->photo_gal($config['per_page'], $start);
    ...
    public function all_inactiveusers() {
        $otherusers = $this->usermodel->all_inactiveusers($_POST);
        $result_count = $this->usermodel->all_inactiveusers($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function inactiveusers_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_inactiveusers($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function users_excel_export() {
        ...
        $rides = $this->usermodel->all_otherusers($_GET);
        if ($rides) {
            //print_r($rides);exit;
            $this->load->library('excel'); // load Excel Library
            $object_excel = new PHPExcel(); // new object for PHPExcel
    ...
    public function all_otherusers() {
        $otherusers = $this->usermodel->all_otherusers($_POST);
        $result_count = $this->usermodel->all_otherusers($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function user_details($id) {
        ...
        if ($query = $this->usermodel->user_details()) {
            $this->data['row'] = $query;
...
//            die;
    ...
    public function update_verification() {
        ...
        $this->usermodel->update_verification($this->data, $this->input->post('status_id'));
        $this->session->set_flashdata('success', 'Record Updated Successfully.');
    ...
    public function verification() {
        ...
        if ($query = $this->usermodel->edit_verification()) {
            $this->data['row'] = $query;
        }
    ...
    public function ChangePassword() {
        $this->data['title'] = "CIAO Rides";
        if ($query = $this->usermodel->AdminDetails()) {
            $this->data['row'] = $query;
        }
        //var_dump($this->data['row']);
        $this->load->view('admin/includes/header', $this->data);
    ...
    public function UpdatePassword() {
        ...
        $this->data['modified_on'] = date('Y-m-d H:i:s');
        $this->usermodel->UpdatePassword($this->data);
    ...
    public function change_user_status($user_id, $status) {
        if ($this->usermodel->change_user_status($user_id, $status) == true) {
    ...
    public function all_push_notifications() {
        $notifications = $this->usermodel->all_push_notifications($_POST);
        $result_count = $this->usermodel->all_push_notifications($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function push_notifications_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_push_notifications($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function push_notifications() {
        $this->data['title'] = "Bikes7";
        $this->data['items'] = $this->usermodel->all_push_notifications($_POST);
        $this->load->view('admin/includes/header', $this->data);
    ...
    public function send_push_notification() {
        $sent_to = "user";
        $query = $this->usermodel->send_push_notification($this->input->post('description'), $this->input->post('title'), $sent_to);
        if ($query == true) {
    ...
    public function all_support() {
        $support = $this->usermodel->all_support($_POST);
        $result_count = $this->usermodel->all_support($_POST, 1);
        $json_data = array(
            "draw" => intval($_POST['draw']),
            "iTotalRecords" => intval($result_count),
            "iTotalDisplayRecords" => intval($result_count),
    ...
    public function support_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_support($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
    ...
    public function update_support() {
        if ($this->input->post('sub_category_id') == "") {
            ...
            $this->usermodel->insert_support($this->data);
            $this->session->set_flashdata('success', 'Record added Successfully.');
            ...
            $this->data['modified_on'] = date('Y-m-d H:i:s');
            $this->usermodel->update_support($this->data, $this->input->post('sub_category_id'));
            $this->session->set_flashdata('success', 'Record Updated Successfully.');
    ...
    public function edit_support($support_id) {
        $this->data['title'] = "CIAO Rides";
        if ($query = $this->usermodel->edit_support()) {
            $this->data['row'] = $query;
        }
        $this->data['categories'] = $this->usermodel->vehicle_makes();
        $this->data['sub_categories'] = $this->usermodel->support();
...
//        echo '</pre>';
    ...
    function all_taxi_drivers() {
        #pagination code start
        $config['base_url'] = base_url() . 'admin/user_management/all_taxi_drivers';
        $config['total_rows'] = $this->usermodel->photo_gal_count_taxi_drivers();
        $config['per_page'] = 20;
        $config['page_query_string'] = true;
        ...
        #pagination code end
        //$this->data['webprofile'] = $this->Main_model->webprofile();
        $this->data['photo'] = $this->usermodel->photo_gal_taxi_drivers($config['per_page'], $start);
     ...
     //  exit;
        ...
        $this->load->view('admin/includes/header', $this->data);
        $this->load->view('admin/all_taxi_drivers_list', $this->data);
        $this->load->view('admin/includes/footer', $this->data);
    }
    
    
    public function change_taxi_drivers_status($user_id, $status) {
        if ($this->usermodel->change_user_status($user_id, $status) == true) {
            $this->session->set_flashdata('success', 'Status Updated Successfully.');
        } else {
            $this->session->set_flashdata('fail', 'Error in Updating.');
        }
        redirect('admin/user_management/all_taxi_drivers', 'refresh');
    }

    
    
    public function taxi_drivers_details($id) {
        $this->data['title'] = "CIAO Rides";
        $this->data['user_vehicles'] = '';
        if ($query = $this->usermodel->user_details()) {
            $this->data['row'] = $query;
...
//            die;
            if ($this->db->affected_rows() > 0) {
                $this->session->set_flashdata('success', 'Updated Successfully.');
                redirect('admin/user_management/user_details/' . $id, 'refresh');
            } else {
                $this->session->set_flashdata('failed', 'Updated Failed.');
                redirect('admin/user_management/user_details/' . $id, 'refresh');
            }
    ...
    public function taxi_drivers_excel_export() {
        //print_r($_GET);exit;
        $rides = $this->usermodel->all_taxi_drivers_details($_GET);
        //print_r($rides);exit;
        $this->load->library('excel'); // load Excel Library
        $object_excel = new PHPExcel(); // new object for PHPExcel
        $object_excel->setActiveSheetIndex(0); // Create new worksheet
        $table_head = array('S.No', 'First Name','Last Name', 'Mobile', 'Email Id', 'Created Date'); //Set the names of header cells
        $head = 0;
        foreach ($table_head as $value) {
            $object_excel->getActiveSheet()->setCellValueByColumnAndRow($head, 1, $value);
            $head++;
        ...
        $object_excel_writer = PHPExcel_IOFactory::createWriter($object_excel, 'Excel5'); // Explain format of Excel data
        header('Content-Type: application/vnd.ms-excel');
        header('Content-Disposition: attachment;filename="Taxi Driver List.xls"');
        $object_excel_writer->save('php://output'); // For automatic download to local computer
        redirect(base_url() . 'user_management/all_taxi_drivers');
    }
    ...
    function all_passengers() {
        #pagination code start
        $config['base_url'] = base_url() . 'admin/user_management/all_passengers';
        $config['total_rows'] = $this->usermodel->photo_gal_count_passengers();
        $config['per_page'] = 20;
        $config['page_query_string'] = true;
        ...
        #pagination code end
        //$this->data['webprofile'] = $this->Main_model->webprofile();
        $this->data['photo'] = $this->usermodel->photo_gal_passengers($config['per_page'], $start);
        // 		$this->front_view('sample',$this->data);

        $this->load->view('admin/includes/header', $this->data);
        $this->load->view('admin/all_passengers_list', $this->data);
        $this->load->view('admin/includes/footer', $this->data);
    }
    
    
    public function change_passengers_status($user_id, $status) {
        if ($this->usermodel->change_user_status($user_id, $status) == true) {
            $this->session->set_flashdata('success', 'Status Updated Successfully.');
        } else {
            $this->session->set_flashdata('fail', 'Error in Updating.');
        }
        redirect('admin/user_management/all_passengers_list', 'refresh');
    }

    
    
    public function passengers_details($id) {
        $this->data['title'] = "CIAO Rides";
        $this->data['user_vehicles'] = '';
        if ($query = $this->usermodel->user_details()) {
            $this->data['row'] = $query;
...
//            die;
    ...
    function all_private_users() {
        #pagination code start
        $config['base_url'] = base_url() . 'admin/user_management/all_private_users';
        $config['total_rows'] = $this->usermodel->photo_gal_count_all_private_users();
        $config['per_page'] = 20;
        $config['page_query_string'] = true;
        ...
        #pagination code end
        //$this->data['webprofile'] = $this->Main_model->webprofile();
        $this->data['photo'] = $this->usermodel->photo_gal_all_private_users($config['per_page'], $start);
        // 		$this->front_view('sample',$this->data);

        $this->load->view('admin/includes/header', $this->data);
        $this->load->view('admin/all_private_users_list', $this->data);
        $this->load->view('admin/includes/footer', $this->data);
    }
    
    
    public function change_privatedrivers_status($user_id, $status) {
        if ($this->usermodel->change_user_status($user_id, $status) == true) {
            $this->session->set_flashdata('success', 'Status Updated Successfully.');
        } else {
            $this->session->set_flashdata('fail', 'Error in Updating.');
        }
        redirect('admin/user_management/all_private_users', 'refresh');
    }

    
    
    public function privatedrivers_details($id) {
        $this->data['title'] = "CIAO Rides";
        $this->data['user_vehicles'] = '';
        if ($query = $this->usermodel->user_details()) {
            $this->data['row'] = $query;
