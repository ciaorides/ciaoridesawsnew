            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Support  </h5>
                            <span>List Support Queries  </span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                                ...
                                <form id="fees_form" name="search_fees" method="post" class="pull-right">
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/support'); ?>"><li class="fa fa-minus icon-style"></li></a>
...
<script>
                                                ...
                                                $(document).ready(function () {
                                                    dtabel = $('#users').DataTable({
                                                        ...
                                                        "destroy": true,
                                                        "ajax": {
                                                            "url": "<?php echo base_url('admin/register/all_support'); ?>",
                                                            "type": "POST",
                                                            beforeSend: function () {
                                                        ...
                                                        "columns": [
                                                            ...
                                                            {"title": "First Name", "name": "First Name", "orderable": false, "data": "first_name", "width": "0%"},
                                                            {"title": "Last Name", "name": "Last Name", "orderable": false, "data": "last_name", "width": "0%"},
                                                            {"title": "Mobile", "name": "Mobile", "orderable": false, "data": "mobile", "width": "0%"},
                                                            {"title": "Email ID", "name": "Email ID", "orderable": false, "data": "email_id", "width": "0%"},
                                                            {"title": "Booking ID", "name": "Order ID", "orderable": false, "data": "order_id", "width": "0%"},
                                                        ...
                                                        {
                                                            //var action ='<a class="btn btn-warning btn-condensed" title="edit" href="'+url+'admin/register/edit_support/'+aData['id']+'"><i class="fa fa-edit"></i></a> <a onclick="return confirm('+"'Are you sure want to delete?'"+');" class="btn btn-danger btn-condensed" title="delete" href="'+url+'admin/register/delete_support/'+aData['id']+'"><i class="fa fa-trash"></i></a>';
                                                            //$(nRow).find('td:eq(1)').html(action);
                                                            var order_id = '<a class="te" title="Order Details" href="' + url + 'admin/register/order_details/' + aData['order_id'] + '">' + aData['order_id'] + '</a>';
                                                            $(nRow).find('td:eq(5)').html(order_id);
                                                        },
                                                ...
                                                function excel() {
                                                    ...
                                                    window.location.replace("<?php echo base_url('admin/register/support_excel_export'); ?>?search_text_1=" + search_text_1 + "&&search_on_1=" + search_on_1 + "&&search_at_1=" + search_at_1 + "");
