                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"> All Private Users </li>
                        </ol>
                    </nav>
                </div>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($row->status == 1) { ?>
                                                        ...
                                                        <a href="<?php echo base_url() ?>admin/user_management/change_privatedrivers_status/<?php echo $row->id; ?>/0"><button class="btn btn-success">Active</button></a>
                                                    <?php } else { ?>
                                                        <a href="<?php echo base_url() ?>admin/user_management/change_privatedrivers_status/<?php echo $row->id; ?>/1"><button class="btn btn-danger">Inactive</button></a>
                                                    <?php }
                                                    ?>
                                                </td>
                                                <td>
...
//                                Govt ID (40%), Address (20%), Mobile (10%), Photo (10%), personal Mail ID (10%) and Official Mail ID(10%)
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url(); ?>admin/user_management/privatedrivers_details/<?php echo $row->id; ?>" class="btn btn-outline-success"> View </a> &nbsp; &nbsp;
