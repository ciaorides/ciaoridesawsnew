            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        <i class="fa  fa-cab bg-yellow"></i>
                        <div class="d-inline">
                            <h5>Vehicle Brands  </h5>
                            <span>List Vehicle Brands  </span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="col-md-6 col-xs-6">
                            <h3 class="panel-title" style="float: right;"><a href="<?= base_url(); ?>admin/vehicle_management/add_vehicle_makes" class="btn btn-success">Add</a></h3>
                        </div>
                    </div>
                            ...
                            <table id="users" class="table datatable table-striped">
                                ...
                                <form id="fees_form" name="search_fees" method="post" class="pull-right">
                                    <div class="row">
                                        ...
                                        <input type="hidden" value="1" name="search_on_1" id="search_on_1" />
<!--
                                        <div class="col-md-2">
                                            <select name="search_on_1" id="search_on_1" class="form-control input-sm custom-input">
                                                <option value="1">Vehicle Brands</option>
                                            </select>
                                        </div>
-->
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/vehicle_management/vehicle_makes'); ?>"><li class="fa fa-minus icon-style"></li></a>
...
<script>
                                                ...
                                                $(document).ready(function () {
                                                    dtabel = $('#users').DataTable({
                                                        ...
                                                        "destroy": true,
                                                        "ajax": {
                                                            "url": "<?php echo base_url('admin/vehicle_management/all_vehicle_makes'); ?>",
                                                            "type": "POST",
                                                            beforeSend: function () {
                                                ...
                                                function excel() {
                                                    ...
                                                    window.location.replace("<?php echo base_url('admin/vehicle_management/vehicle_makes_excel_export'); ?>?search_text_1=" + search_text_1 + "&&search_on_1=" + search_on_1 + "&&search_at_1=" + search_at_1 + "");
