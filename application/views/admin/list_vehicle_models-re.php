            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="col-md-6 col-xs-6">
                            <h3 class="panel-title" style="float: right;"><a href="<?= base_url(); ?>admin/register/add_vehicle_models" class="btn btn-success">Add</a></h3>
                        </div>
                    </div>
                                ...
                                <form id="fees_form" name="search_fees" method="post" class="pull-right">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/vehicle_models'); ?>"><li class="fa fa-minus icon-style"></li></a>
...
<script>
                                                ...
                                                $(document).ready(function () {
                                                    dtabel = $('#users').DataTable({
                                                        ...
                                                        "destroy": true,
                                                        "ajax": {
                                                            "url": "<?php echo base_url('admin/register/all_vehicle_models'); ?>",
                                                            "type": "POST",
                                                            beforeSend: function () {
                                                ...
                                                function excel() {
                                                    ...
                                                    window.location.replace("<?php echo base_url('admin/register/vehicle_models_excel_export'); ?>?search_text_1=" + search_text_1 + "&&search_on_1=" + search_on_1 + "&&search_at_1=" + search_at_1 + "");
