                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">User Ratings </li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <form id="fees_form" name="search_fees" method="post" class="pull-right">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/user_ratings'); ?>"><li class="fa fa-minus icon-style"></li></a>
...
<script>
                                                ...
                                                $(document).ready(function () {
                                                    dtabel = $('#users').DataTable({
                                                        ...
                                                        "destroy": true,
                                                        "ajax": {
                                                            "url": "<?php echo base_url('admin/register/all_user_ratings'); ?>",
                                                            "type": "POST",
                                                            beforeSend: function () {
                                                        ...
                                                        "columns": [
                                                            ...
                                                            //{ "title": "Order Id", "name":"order_id","orderable": false, "data":"order_id", "width":"0%" },
                                                            {"title": "Booking Id", "name": "Booking Id", "orderable": false, "data": "booking_id", "width": "0%"},
                                                            {"title": "Booking Date", "name": "Booking Date", "orderable": false, "data": "ocreated_on", "width": "0%"},
                                                            {"title": "ratings", "name": "ratings", "orderable": false, "data": "ratings", "width": "0%"},
                                                            {"title": "reviews", "name": "reviews", "orderable": false, "data": "reviews", "width": "0%"},
                                                            {"title": "Created Date", "name": "created_on", "orderable": false, "data": "created_on", "width": "0%"}
                                                        ],
                                                        "fnCreatedRow": function (nRow, aData, iDataIndex)
                                                        {
                                                            var action = '<a onclick="return confirm(' + "'Are you sure want to delete?'" + ');" class="btn btn-danger btn-condensed" title="delete" href="' + url + 'admin/register/delete_user_ratings/' + aData['id'] + '"><i class="fa fa-trash"></i></a>';
                                                ...
                                                function excel() {
                                                    ...
                                                    window.location.replace("<?php echo base_url('admin/register/user_ratings_excel_export'); ?>?search_text_1=" + search_text_1 + "&&search_on_1=" + search_on_1 + "&&search_at_1=" + search_at_1 + "");
