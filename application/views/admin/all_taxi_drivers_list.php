                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"> All Taxi Drivers </li>
                        </ol>
                    </nav>
                </div>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($row->status == 1) { ?>
                                                        ...
                                                        <a href="<?php echo base_url() ?>admin/user_management/change_taxi_drivers_status/<?php echo $row->id; ?>/0"><button class="btn btn-success">Active</button></a>
                                                    <?php } else { ?>
                                                        <a href="<?php echo base_url() ?>admin/user_management/change_taxi_drivers_status/<?php echo $row->id; ?>/1"><button class="btn btn-danger">Inactive</button></a>
                                                    <?php }
                                                    ?>
                                                </td>
                                                <td>
...
//                                Govt ID (40%), Address (20%), Mobile (10%), Photo (10%), personal Mail ID (10%) and Official Mail ID(10%)
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url(); ?>admin/user_management/taxi_drivers_details/<?php echo $row->id; ?>" class="btn btn-outline-success"> View </a> &nbsp; &nbsp;
                                                    <a  href="<?= base_url('user_management/delete_otherusers/' . $row->id) ?>"  onclick="return confirm('Are you sure?')"  class="btn btn-outline-danger">Delete</a> </td>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <!-- <div class="col-md-6 col-xs-6">
                      <h3 class="panel-title" style="float: right;"><a href="<?= base_url(); ?>admin/user_management/add_otherusers" class="btn btn-success">Add</a></h3>
                    </div> -->
                </div>
...
<script>
          function excel() {
                                                    ...
                                                    window.location.replace("<?php echo base_url('admin/user_management/taxi_drivers_excel_export'); ?>?search_text_1=" + search_text_1 + "&&search_on_1=" + search_on_1 + "&&search_at_1=" + search_at_1 + "");
