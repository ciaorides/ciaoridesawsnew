                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"> Ongoing Rides </li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <form id="fees_form" name="search_fees" method="post" class="pull-right">
                                    <div class="col-md-12 row" >
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/shceduled'); ?>"><li class="fa fa-minus icon-style"></li></a>
...
<ul class="breadcrumb">
    <li><a href="#">Home</a></li>
    <li class="active">Shceduled Rides</li>
</ul>
...
<script>
                                                ...
                                                $(document).ready(function () {
                                                    dtabel = $('#users').DataTable({
                                                        ...
                                                        "destroy": true,
                                                        "ajax": {
                                                            "url": "<?php echo base_url('admin/register/all_shceduled'); ?>",
                                                            "type": "POST",
                                                            beforeSend: function () {
                                                        ...
                                                        "columns": [
                                                            ...
                                                            {"title": "ride mode", "name": "ride_mode", "orderable": false, "data": "mode", "width": "0%"},
                                                            {"title": "ride type", "name": "ride_type", "orderable": false, "data": "ride_type", "width": "0%"},
                                                            ...
                                                            {"title": "Ride booking Date", "name": "Ride booking date", "orderable": false, "data": "created_on", "width": "0%"},

                                                            {"title": "Ride starting Date", "name": "Ride starting date", "orderable": false, "data": "ride_time", "width": "0%"},
                                                            {"title": "Modified Date", "name": "modified_on", "orderable": false, "data": "modified_on", "width": "0%"}

                                                        ],
                                                        "fnCreatedRow": function (nRow, aData, iDataIndex)
                                                        {
                                                            var action = '<a onclick="return confirm(' + "'Are you sure want to delete?'" + ');" class="btn btn-danger btn-condensed" title="delete" href="' + url + 'admin/register/delete_shceduled/' + aData['id'] + '"><i class="fa fa-trash"></i></a>';
                                                            $(nRow).find('td:eq(1)').html(action);
                                                            var status = '<a class="btn btn-warning btn-condensed" title="" href="' + url + 'admin/register/shceduled_details/' + aData['id'] + '" class="btn btn-success btn-condensed">View</a>';
                                                ...
                                                function excel() {
                                                    ...
                                                    window.location.replace("<?php echo base_url('admin/register/scheduled_excel_export'); ?>?search_text_1=" + search_text_1 + "&&search_on_1=" + search_on_1 + "&&search_at_1=" + search_at_1 + "");
