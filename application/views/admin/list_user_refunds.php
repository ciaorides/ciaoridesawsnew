...
<ul class="breadcrumb">
    <li><a href="#">Home</a></li>
    <li class="active">User Refunds</li>
</ul>
<!-- END BREADCRUMB -->
<!-- END PAGE TITLE -->
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="col-md-6 col-xs-6">
                        <h2><span class="fa fa-list"></span> User Refunds</h2>
                    </div>
...
<script>
                                        ...
                                        $(document).ready(function () {
                                            dtabel = $('#users').DataTable({
                                                ...
                                                "destroy": true,
                                                "ajax": {
                                                    "url": "<?php echo base_url('admin/register/all_user_refunds'); ?>",
                                                    "type": "POST",
                                                    beforeSend: function () {
                                                ...
                                                {
                                                    var action = '<a onclick="return confirm(' + "'This order will be marked as refunded!'" + ');" class="btn btn-success btn-condensed" title="delete" href="' + url + 'admin/register/make_refund/' + aData['oid'] + '"><i class="fa fa-check"></i></a>';
