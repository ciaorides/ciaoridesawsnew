    ...
    <div class="container-fluid">
        <div class="page-header">
            <div class="row align-items-end">
             ...
             <li  class="nav-item"  >
             	<a class="nav-link <?php if($type == 'car'){ ?> active <?php } ?>" href="<?php echo base_url().'admin/city_management/city_cancellation/car'?>" > <b>Car</b>  </a>
             	</li>
             	<li  class="nav-item"  >
             	<a class="nav-link <?php if($type == 'bike'){ ?> active <?php } ?>" href="<?php echo base_url().'admin/city_management/city_cancellation/bike'?>" ><b>Bike </b> </a>
             	</li>
             	<li  class="nav-item"  >
             	<a class="nav-link <?php if($type == 'auto'){ ?> active <?php } ?>" href="<?php echo base_url().'admin/city_management/city_cancellation/auto'?>" ><b>Auto </b> </a>
             </li>
                    ...
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5><?php echo $named_type;?> Cancellation  </h5>
                            <span>All <?php echo $named_type;?> Cancellation </span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3><?php echo $named_type;?> Cancellation List</h3>
                    </div>
                                ...
                                <form id="fees_form" name="search_fees" method="post" class="pull-right">
                                    <div class="container-fluid row" style="padding:0">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/city_management/city_cancellation').'/'.$type; ?>"><li class="fa fa-minus icon-style"></li></a>
...
<script>
                                                ...
                                                $(document).ready(function () {
                                                    dtabel = $('#users').DataTable({
                                                        ...
                                                        "destroy": true,
                                                        "ajax": {
                                                            "url": "<?php echo base_url('admin/city_management/all_city_cancellation'); ?>",
                                                            "type": "POST",
                                                            beforeSend: function () {
