<div class="main-content">
    <div class="container-fluid">
        ...
        <div class="panel-heading">
             ...
             <li  class="nav-item"  >
                <a class="nav-link <?php if($type == 'car'){ ?> active <?php } ?>" href="<?php echo base_url().'admin/city_management/bookings/car'?>" > <b>Car</b>  </a>
                </li>
                <li  class="nav-item"  >
                <a class="nav-link <?php if($type == 'bike'){ ?> active <?php } ?>" href="<?php echo base_url().'admin/city_management/bookings/bike'?>" ><b>Bike </b> </a>
                </li>
                <li  class="nav-item"  >
                <a class="nav-link <?php if($type == 'auto'){ ?> active <?php } ?>" href="<?php echo base_url().'admin/city_management/bookings/auto'?>" ><b>Auto </b> </a>
             </li>
                    ...
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5><?php echo $named_type;?> Bookings   </h5>
                            <span> All <?php echo $named_type;?> Bookings List</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"> Instant Bookings   </li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <form id="fees_form" name="search_fees" method="post" class="pull-right">
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/city_management/bookings/car'); ?>"><li class="fa fa-minus icon-style"></li></a>
...
dtabel = $('#users').DataTable({
    ...
    "destroy": true,
    "ajax": {
        "url": "<?php echo base_url('admin/city_management/get_all_bookings'); ?>",
        "type": "POST",
        beforeSend: function () {
    ...
    "columns": [
        ...
        {"title": "Invoice", "name": "id", "orderable": false, "deafultContent": "", "data": "id", "width": "0%"},
...
var invoice = '<a target="_blank" class="btn btn-primary btn-condensed" title="" href="' + url + 'admin/register/invoice/' + aData['id'] + '" class="btn btn-success btn-condensed">Invoice </a>';
$(nRow).find('td:eq(3)').html(invoice);
...
window.location.replace("<?php echo base_url('admin/city_management/bookings_excel_export/'.$type); ?>?search_text_1=" + search_text_1 + "&&search_on_1=" + search_on_1 + "&&search_at_1=" + search_at_1 + "");
