                                ...
                                <form id="fees_form" name="search_fees" method="post" class="pull-right">
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/instantorders'); ?>"><li class="fa fa-minus icon-style"></li></a>
...
<script>
                                                ...
                                                $(document).ready(function () {
                                                    dtabel = $('#users').DataTable({
                                                        ...
                                                        "destroy": true,
                                                        "ajax": {
                                                            "url": "<?php echo base_url('admin/register/get_all_bookings'); ?>",
                                                            "type": "POST",
                                                            beforeSend: function () {
                                                        ...
                                                        "fnCreatedRow": function (nRow, aData, iDataIndex)
                                                        {
                                                            ...
                                                            var status = '<a class="btn btn-warning btn-condensed" title="" href="' + url + 'admin/register/order_details/' + aData['id'] + '" class="btn btn-success btn-condensed">View</a>\n\
                                                                                                                <a target="_blank" class="btn btn-primary btn-condensed" title="" href="' + url + 'admin/register/invoice/' + aData['id'] + '" class="btn btn-success btn-condensed">Invoice </a>';
