                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Add Vehicle Models</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<div class="page-content-wrap">
  <div class="row">
    <div class="col-md-12">
      ...
      echo form_open_multipart('admin/vehicle_management/update_vehicle_models', $attributes); 
      ?>
        <div class="panel panel-default">
          ...
          <div class="panel-footer">
            <a href="<?=base_url();?>admin/vehicle_management/vehicle_models" class="btn btn-primary pull-right" style="margin-left:10px;">Cancel</a>    
...
<script>
  ...
  function get_vehicle_brands(vehicle_type)
  {
    ...
    $.ajax({
      type: 'post',
      url: '<?=base_url();?>admin/vehicle_management/get_vehicle_brands',
