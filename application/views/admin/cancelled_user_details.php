...
<ul class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li><a href="#">Bookings cancelled by user</a></li>
  <li class="active">Bookings cancelled by user</li>
</ul>
<!-- END BREADCRUMB -->
      ...
      ?>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Bookings cancelled by user</h2>
          </div>
          ...
          <div class="panel-body">  
            ...
            <div class="form-group">
              <label for="title" class="col-md-3 col-xs-12 control-label">Rider Name: </label>
              <div class="col-md-6 col-xs-12 margintop7">  
              <?=$row['ufirst_name'];?> <?=$row['ulast_name'];?>
              </div>
            </div>
            <!-- <div class="form-group">
            ...
            <div class="form-group">
              <label for="title" class="col-md-3 col-xs-12 control-label">Cancellation Charges: </label>
              <div class="col-md-6 col-xs-12 margintop7">  
