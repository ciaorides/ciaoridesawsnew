            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Bookings Canceled by user </h5>
                            <span>List Bookings Canceled by user </span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Bookings Canceled by user </li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <form id="fees_form" name="search_fees" method="post" class="pull-right">
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/cancelled_user'); ?>"><li class="fa fa-minus icon-style"></li></a>
...
<script>
                                                ...
                                                $(document).ready(function () {
                                                    dtabel = $('#users').DataTable({
                                                        ...
                                                        "destroy": true,
                                                        "ajax": {
                                                            "url": "<?php echo base_url('admin/register/all_cancelled_user'); ?>",
                                                            "type": "POST",
                                                            beforeSend: function () {
                                                        ...
                                                        "columns": [
                                                            ...
                                                            {"title": "Driver Name", "name": "first_name", "orderable": false, "data": "uname", "width": "0%"},
                                                        ...
                                                        {
                                                            var action = '<a onclick="return confirm(' + "'Are you sure want to delete?'" + ');" class="btn btn-danger btn-condensed" title="delete" href="' + url + 'admin/register/delete_cancelled_user/' + aData['id'] + '"><i class="fa fa-trash"></i></a>';
                                                            ...
                                                            var rname = '<a  title="Click to view details" href="' + url + 'admin/register/user_details/' + aData['r_id'] + '" >' + aData['uname'] + '</a>';
                                                            $(nRow).find('td:eq(5)').html(rname);
                                                        },
                                                ...
                                                function excel() {
                                                    ...
                                                    window.location.replace("<?php echo base_url('admin/register/cancelled_user_excel_export'); ?>?search_text_1=" + search_text_1 + "&&search_on_1=" + search_on_1 + "&&search_at_1=" + search_at_1 + "");
