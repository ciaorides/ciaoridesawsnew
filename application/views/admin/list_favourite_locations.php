...
<ul class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li class="active">Favourite Locations</li>
</ul>
<!-- END BREADCRUMB -->
<!-- END PAGE TITLE -->
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-list"></span> Favourite Locations</h2>
        </div>
        ...
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/favourite_locations'); ?>"><li class="fa fa-minus icon-style"></li></a>
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/all_favourite_locations'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "Contact Number", "name":"Contact Number", "orderable": false, "deafultContent":"", "data": "mobile", "width":"0%"},
            { "title": "Type of Location", "name":"Type of Location","orderable": false, "data":"type", "width":"0%" },
             { "title": "address", "name":"address","orderable": false, "data":"address", "width":"0%" },
             { "title": "lat", "name":"lat","orderable": false, "data":"lat", "width":"0%" },
        ...
        {
          var action ='<a onclick="return confirm('+"'Are you sure want to delete?'"+');" class="btn btn-danger btn-condensed" title="delete" href="'+url+'admin/register/delete_favourite_locations/'+aData['id']+'"><i class="fa fa-trash"></i></a>';
...
function excel(){
    ...
    window.location.replace("<?php echo base_url('admin/register/favourite_locations_excel_export'); ?>?search_text_1="+search_text_1+"&&search_on_1="+search_on_1+"&&search_at_1="+search_at_1+"");
